...
public class FunctionSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FunctionPackage.FUNCTION_LIST: {
				FunctionList functionList = (FunctionList)theEObject;
				Object result = caseFunctionList(functionList);
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseFunctionList(FunctionList object) {
		return null;
	}
