 ...
 *
 */
public class EventEditorAction extends Action {
	
	public static final String ID = "Event_Editor_Action";
	private DSCDiagram parent; 
	
	

	public EventEditorAction() {
		
		
		this.setId(ID);
		this.setText("Event Editor");
...
public void run ()
{
	...
	OpenEventEditor openEventEditor= new OpenEventEditor(parent);
	openEventEditor.open();
	}
}
