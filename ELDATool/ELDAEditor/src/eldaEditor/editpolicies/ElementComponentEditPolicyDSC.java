...
import eldaEditor.commands.ElementDeleteCommandDSC;
 ...
 * @author samuele
 */
public class ElementComponentEditPolicyDSC extends ComponentEditPolicy {
private Command com;
...
protected Command createDeleteCommand(GroupRequest deleteRequest) {
	...
	if(child instanceof VisualElement) {
		com = new ElementDeleteCommandDSC((VisualElement)child); 
		return com;
	}
