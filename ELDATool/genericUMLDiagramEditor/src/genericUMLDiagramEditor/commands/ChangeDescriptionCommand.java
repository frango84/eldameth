...
/**
 * Change the description of the passed ModelElement
 * 
 * @author marguu&zaza
 *
 */
public class ChangeDescriptionCommand extends ChangeNameCommand {

  public ChangeDescriptionCommand(ModelElement model, String string) {
	  super(model,string);
  }
