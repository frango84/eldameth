...
/**
 * It allows users to input the properties for a Container
 * 
 * @author marguu&zaza
 *
 */
...
public class ContainerPropertiesInputDialog extends Dialog {
   ...
   */
  public ContainerPropertiesInputDialog(Shell parent) {
   ...
   */
  public ContainerPropertiesInputDialog(Shell parent, int style) {
   ...
   * @param parent the parent
   * @param style  the style
   * @param task   the associated container
   */
  public ContainerPropertiesInputDialog(Shell parent, int style, Container task) {
    // Let users override the default styles
    super(parent, style);
    setText("Container Properties");
    this.task=task;
   ...
   * @param task   the associated container
   */
  public ContainerPropertiesInputDialog(Shell parent, Container task) {
    // Let users override the default styles
    super(parent);
    setText("Container Properties");
    this.task=task;
  ...
  private void createContents(final Shell shell) {
    ...
    title1.setText("Properties of the container");
