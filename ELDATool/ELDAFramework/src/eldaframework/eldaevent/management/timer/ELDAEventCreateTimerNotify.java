...
public abstract class ELDAEventCreateTimerNotify extends ELDAEventManagement implements Serializable{
	...
	/**
 	...
 	public ELDAEventCreateTimerNotify(ELDAId source, ELDAId target, Object timer){
  		super(source, target);
  		this.timer=timer;
  		setIn();
 	}

 	public ELDAEventCreateTimerNotify(ELDAId target, Object timer){
  		super(target, target);
  		this.timer=timer;
  		setIn();
 	}
