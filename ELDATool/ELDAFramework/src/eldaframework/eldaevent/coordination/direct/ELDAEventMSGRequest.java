...
public class ELDAEventMSGRequest extends ELDAEventDirect implements Serializable{
...
//	public ELDAEventMSGRequest(ELDAId source, ELDAId target, ELDAEventMSG msg){
// 		super(source, target);
// 		this.msg=msg;
// 		setOut();
// 	}
	public ELDAEventMSGRequest(ELDAId source, ELDAEventMSG msg){
 		super(source, source);
 		this.msg=msg;
 	}
