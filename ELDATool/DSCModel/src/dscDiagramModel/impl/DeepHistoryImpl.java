 ...
 * <ul>
 *   <li>{@link dscDiagramModel.impl.DeepHistoryImpl#getCompositeState <em>Composite State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeepHistoryImpl extends ClassifierImpl implements DeepHistory {
	/**
	...
	protected EClass eStaticClass() {
		return DscDiagramModelPackage.eINSTANCE.getDeepHistory();
	}
		...
		if (compositeState != null && compositeState.eIsProxy()) {
			...
			if (compositeState != oldCompositeState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DscDiagramModelPackage.DEEP_HISTORY__COMPOSITE_STATE, oldCompositeState, compositeState));
			}
		}
	...
	public NotificationChain basicSetCompositeState(DSCState newCompositeState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DscDiagramModelPackage.DEEP_HISTORY__COMPOSITE_STATE, oldCompositeState, newCompositeState);
	...
	public void setCompositeState(DSCState newCompositeState) {
		if (newCompositeState != compositeState) {
			...
			if (compositeState != null)
				msgs = ((InternalEObject)compositeState).eInverseRemove(this, DscDiagramModelPackage.DSC_STATE__DEEP_HISTORY, DSCState.class, msgs);
			if (newCompositeState != null)
				msgs = ((InternalEObject)newCompositeState).eInverseAdd(this, DscDiagramModelPackage.DSC_STATE__DEEP_HISTORY, DSCState.class, msgs);
			msgs = basicSetCompositeState(newCompositeState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DscDiagramModelPackage.DEEP_HISTORY__COMPOSITE_STATE, newCompositeState, newCompositeState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case DscDiagramModelPackage.DEEP_HISTORY__PARENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, DscDiagramModelPackage.DEEP_HISTORY__PARENT, msgs);
				case DscDiagramModelPackage.DEEP_HISTORY__SOURCE_RELATIONSHIPS:
					return ((InternalEList)getSourceRelationships()).basicAdd(otherEnd, msgs);
				case DscDiagramModelPackage.DEEP_HISTORY__TARGET_RELATIONSHIPS:
					return ((InternalEList)getTargetRelationships()).basicAdd(otherEnd, msgs);
				case DscDiagramModelPackage.DEEP_HISTORY__CONTAINER:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, DscDiagramModelPackage.DEEP_HISTORY__CONTAINER, msgs);
				case DscDiagramModelPackage.DEEP_HISTORY__COMPOSITE_STATE:
					if (compositeState != null)
						msgs = ((InternalEObject)compositeState).eInverseRemove(this, DscDiagramModelPackage.DSC_STATE__DEEP_HISTORY, DSCState.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case DscDiagramModelPackage.DEEP_HISTORY__PARENT:
					return eBasicSetContainer(null, DscDiagramModelPackage.DEEP_HISTORY__PARENT, msgs);
				case DscDiagramModelPackage.DEEP_HISTORY__SOURCE_RELATIONSHIPS:
				...
				case DscDiagramModelPackage.DEEP_HISTORY__CONTAINER:
					return eBasicSetContainer(null, DscDiagramModelPackage.DEEP_HISTORY__CONTAINER, msgs);
				case DscDiagramModelPackage.DEEP_HISTORY__COMPOSITE_STATE:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case DscDiagramModelPackage.DEEP_HISTORY__NAME:
				return getName();
			case DscDiagramModelPackage.DEEP_HISTORY__DESCRIPTION:
			...
			case DscDiagramModelPackage.DEEP_HISTORY__STEREOTYPE:
				return getStereotype();
			case DscDiagramModelPackage.DEEP_HISTORY__ID:
				return getID();
			case DscDiagramModelPackage.DEEP_HISTORY__LOCATION:
				return getLocation();
			case DscDiagramModelPackage.DEEP_HISTORY__SIZE:
				return getSize();
			case DscDiagramModelPackage.DEEP_HISTORY__CONTAINER:
				return getContainer();
			case DscDiagramModelPackage.DEEP_HISTORY__COMPOSITE_STATE:
