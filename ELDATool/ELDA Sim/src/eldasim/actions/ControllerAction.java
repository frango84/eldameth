 ...
 */
public class ControllerAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		GUIStarter.startSimulatorController();
	}
