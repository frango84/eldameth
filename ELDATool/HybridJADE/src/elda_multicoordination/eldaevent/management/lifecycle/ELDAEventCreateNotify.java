...
/**
* Event used to notify that an agent was created.
* 
* @author G. Fortino, F. Rango
*/
public class ELDAEventCreateNotify extends ELDAEventLifecycle {
	
	/**
	 * AID of the created agent
	 */
	private AID createdAgentAID;
	...
	public AID getCreatedAgentAID() {
		return createdAgentAID;
	}

	public void setCreatedAgentAID(AID createdAgentAID) {
		this.createdAgentAID = createdAgentAID;
	}
