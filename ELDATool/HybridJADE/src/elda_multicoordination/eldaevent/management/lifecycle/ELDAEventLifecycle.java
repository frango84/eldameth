...
import jade.core.*;
import elda_multicoordination.eldaevent.management.ELDAEventManagement;

/**
 * @author G. Fortino, F. Rango
 */
public class ELDAEventLifecycle extends ELDAEventManagement {
	 ...
	 */
	public ELDAEventLifecycle(AID source, java.util.List<AID> target){
	 	super(source, target);
	}
