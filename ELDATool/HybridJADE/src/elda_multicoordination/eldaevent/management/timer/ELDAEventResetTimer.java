...
/**
* Event used to reset a timer.
* 
* @author G. Fortino, F. Rango
*/
public class ELDAEventResetTimer extends ELDAEventTimer {
	
	/**
	 * ID of the timer to reset
	 */
	private int timerId;
	 ...
	 */
 	public ELDAEventResetTimer(AID source, int timerId){
