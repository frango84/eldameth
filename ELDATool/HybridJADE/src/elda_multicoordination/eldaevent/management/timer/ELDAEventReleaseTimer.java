...
/**
* Event used to release a timer.
* 
* @author G. Fortino, F. Rango
*/
public class ELDAEventReleaseTimer extends ELDAEventTimer {
	
	/**
	 * ID of the timer to release
	 */
	private int timerId;
	 ...
	 * @param timerId ID of the timer to release
	 */
 	public ELDAEventReleaseTimer(AID source, int timerId){
