...
/**
* This event represents a timeout notification.
* 
* @author G. Fortino, F. Rango
*/
public class ELDAEventTimeoutNotify extends ELDAEventTimer {
	
	/**
	 * ID of the timer that has launched this timeout notification
	 */
	private int timerId;
