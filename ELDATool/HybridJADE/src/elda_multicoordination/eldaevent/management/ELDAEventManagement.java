...
package elda_multicoordination.eldaevent.management;
 ...
 */
public class ELDAEventManagement extends ELDAEvent {
	 ...
	 */
	public ELDAEventManagement(AID source, java.util.List<AID> target){
	 	super(source, target);
	}
