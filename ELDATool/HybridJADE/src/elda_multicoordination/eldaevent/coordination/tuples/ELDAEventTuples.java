...
import jade.core.*;
import elda_multicoordination.eldaevent.coordination.ELDAEventCoordination;

/**
 * @author G. Fortino, F. Rango
 */
public class ELDAEventTuples extends ELDAEventCoordination {
	 ...
	 */
	public ELDAEventTuples(AID source, java.util.List<AID> target){
 		super(source, target);
 	}
