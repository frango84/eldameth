...
/**
 * Event used for the tuples returned by the TuCSoN primitives.
 * 
 * @author G. Fortino, F. Rango
 */
public class ELDAEventReturnTuple extends ELDAEventTuples {

 	/**
 	 * Tuple to return after the execution of a TuCSoN primitive
 	 */
