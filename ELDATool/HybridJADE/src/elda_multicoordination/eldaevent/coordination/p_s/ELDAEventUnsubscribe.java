...
/**
 * Event used for unsubscription in Publish/Subscribe model.
 * 
 * @author G. Fortino, F. Rango
 */
public class ELDAEventUnsubscribe extends ELDAEventP_S {

	/**
	 * Name of the topic from which the sender of this event wants to deregister
	 */
	 ...
	 * @param topic Name of the topic from which the sender of this event wants to deregister
	 */
 	public ELDAEventUnsubscribe(AID source, String topic){
